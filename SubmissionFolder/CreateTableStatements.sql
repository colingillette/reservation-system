/*
  This file shows how tables are created in this database, and how the original sample data is inserted. It is strongly recommended you use master.sql to install the full program.
*/
